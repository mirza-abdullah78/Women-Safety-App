    ...
    return Scaffold(
      ...
      body: LayoutBuilder(builder: (context, constraints) {
        return Container(
          ...
          padding: kIsWeb ? const EdgeInsets.symmetric(horizontal: 250,vertical: 50):const EdgeInsets.all(15),
          child: Card(
                              ...
                              child: updatedUser!.profilePhoto != null &&
                                      ...
                                      child: ClipOval(
                                        child: Container(
                                          ...
                                          child: CachedNetworkImage(
                                            imageUrl: updatedUser!.profilePhoto!,
                                          ),
                                        ),
                                      ),
                                    )
                                  : InkWell(
                                      onTap: () async {
                                        // loadAssets();
                                        String? url =
                                            await loadAssets(context, currentUser!);
                                        print('-------- url -------->>> $url');
